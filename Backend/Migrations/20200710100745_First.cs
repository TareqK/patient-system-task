        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfficialIdNumber = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MetadataItemId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(nullable: true),
                    Value = table.Column<string>(nullable: true),
                    PatientId = table.Column<long>(nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MetadataItems", x => x.MetadataItemId);
                    table.ForeignKey(
                        name: "FK_MetadataItems_Patients_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MetadataItems_PatientId",
                table: "MetadataItems",
                column: "PatientId");
